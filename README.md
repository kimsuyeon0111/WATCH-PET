...
| 학번/이름                                                        |  역할 |  |  |
| --- | --- | --- |
| 2025004019 김수연 | **기술 구현 및 시스템 구축                                                                                                      -**네트워크 소켓 프로그래밍 다중 접속 서버 및 멀티스레드 기반의 통신 인프라 구축 -IPC 파이프라인 완성 : 워크스페이스와 대시보드 간 실시간 FIFO 데이터 전송 구현  |  |
| 2021111185    백민아 | **아이디어 기획 및 TUI UI설계                                                                                               -**시스템 아이디어 도출 : 여러 아이디어를 펫 성장 시스템과 연동하는 기획                 -아스키 캐릭터 UI 디자인 : 아스키 기반 펫 진화 및 감정 스위칭 화면 설계 |  |
